...
(function() {
    ...
    c$.configUIActions = function() {
        ...
        c$.UIActions = {
                ...
                try {
                    $.each(fileObjList, function(index, obj) {
                        ...
                        if (window.$fc.findFileEx({
                            ...
                            b$.Notice.dockMessage({
                                message: $Util.fn_tri18n(I18N[c$.language].UI.filePage.Message[
                                    "existOnImport_message"], {
                                    path: obj.filePath
                                }),
                                title: $Util.fn_tri18n(I18N[c$.language].UI.filePage.Message[
                                    "existOnImport_title"])
                            });
                        } else {
                            var newFileObj = window.$fc.getNewFileObj();
            ...
            //===============================================================
            help: function() {
                var url = "https://github.com/Romanysoft/MarkdownD/wiki/Document"
                b$.App.open(url);
            }
        };
    };
        ...
        $Router.go_workspace = function(fileObj) {
            ...
            $.RTYUtils.queue()
                .next(function(next) {
                        ...
                        if (message === c$.NCMessage.fileChange) {
                            if (fileId === c$.g_curWorkFileObj.id) {
                                if (c$.g_current_page === thisPage) {
                                    ...
                                    c$.g_navTitle = (true === c$.g_curWorkFileObj.changed) ?
                                        baseName +
                                        ' [*]' :
                                        baseName;
                    ...
                    // 注册编辑器设置整体发生变化后的处理方式
                    //====================================================================================
                    c$._common_notice_add(thisPage + c$.NCMessage.editorSettingsApplyToAll, function(
                        message,
                        settings) {
                        ...
                        var newEditorMd = c$.g_curWorkFileObj.assEditor = $EditorProvider.createEditor(
                            div_id, $.extend({}, $UserSettings.editorSetting, {
                                ...
                                toolbarAutoFixed: false
                                    ...
                                    ,
                                onload: function() {
                                    $EditorProvider.setContent(c$.g_curWorkFileObj.content_utf8,
                                        this);
                                    c$.g_curWorkFileObj.lastModify = $.now(); // 修改最后编辑的时间
                                ...
                                onchange: function() {
                                    ...
                                    c$.g_curWorkFileObj.changed = (oldContent !==
                                        curContent);
                                    c$.g_curWorkFileObj.lastModify = $.now(); // 修改最后编辑的时间
                                    ...
                                    if (c$.g_curWorkFileObj.changed) {
                                        ...
                                        if (settings.autoSave) {
                                            // 检查间隔
                                            if (($.now() - c$.g_curWorkFileObj.lastModify) >=
                                                settings.autoSaveSecs *
                                                1000) {
                                                c$.g_curWorkFileObj.content_utf8 =
                                                    curContent;
                                                c$.g_curWorkFileObj.changed = false;
                                                ...
                                                if (false == c$.g_curWorkFileObj.is_tmp) { // 非临时文件
                                                    try {
                                                        b$.Binary.createTextFile({
                                                            filePath: c$.g_curWorkFileObj
                                                                .path,
                                                            text: c$.g_curWorkFileObj
                                                                .content_utf8
                                                        });
                                                    } catch (e) {}
                                                }
                                    ...
                                    //发送消息通知
                                    $NoticeCenter.fire(c$.NCMessage.fileChange, c$.g_curWorkFileObj
                                        .id);
                                },
                                onscroll: function() {
